...
def vox_logo(w, h):
    ...
    return (
        ...
        f'<circle cx="{cx}" cy="{cy}" r="{r}" fill="{VOX_TEAL}"/>'
...
icons = {
    ...
    "plugin-icon": vox_logo(144, 144),
    "category-icon": vox_logo(56, 56),
    # Action icons (shown in action picker sidebar)
    "actions/talk": svg_icon(40, 40, VOX_TEAL, "PTT", 10),
    "actions/mode": svg_icon(40, 40, "#008c3c", "MODE", 9),
    "actions/team": svg_icon(40, 40, VOX_TEAL_DIM, "TEAM", 9),
    "actions/user": svg_icon(40, 40, VOX_TEAL_DIM, "USER", 9),
    "actions/panel": svg_icon(40, 40, VOX_TEAL_DIM, "MORE", 9),
}
